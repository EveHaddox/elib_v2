...
function PANEL:Init()
    ...
    self.textPnl.Paint = function(pnl, w, h)
        ...
        draw.SimpleText("Number", "eve.config.popup.small", w / 2, h / 2 + 10, eve.theme.secondaryText, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    end
...
vgui.Register("eve.config.int", PANEL, "EditablePanel")