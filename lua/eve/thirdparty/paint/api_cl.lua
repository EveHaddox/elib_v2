...
do
	...
	if OVERRIDE_SURFACE then
		...
		local oldSetMaterial = eve.surface.OldSetMaterial or eve.surface.SetMaterial
		local oldSetTexture = eve.surface.OldSetTexture or eve.surface.SetTexture
	...
	if OVERRIDE_SURFACE then
		local originalSurface = eve.surface
...
do
	...
	if OVERRIDE_CIRCLES then
		eve.CIRCLE_FILLED = CIRCLE_FILLED
		eve.CIRCLE_OUTLINED = CIRCLE_OUTLINED
		eve.CIRCLE_BLURRED = CIRCLE_BLURRED
